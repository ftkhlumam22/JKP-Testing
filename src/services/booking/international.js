const BookingInternationalModel = require('../../models/booking/internationalModel');
...
class BookingInternational {
    ...
    /* Create BookingInternational */
    async createBookingInternational(req, res) {
        /* Send Notif Email */
        ...
        await BookingInternationalModel.create(req.body)
            .then(result => {
    ...
    /* List BookingInternational */
    async listBookingInternational(req, res) {
        if(req.query.pagination === 'false'){
            await BookingInternationalModel.find()
                .then(result => {
            ...
            await BookingInternationalModel.paginate(condition, options)
                .then(result => {
                    return apiResponse.successResponseWithDataAndPagination(res, result);
                })
                .catch(error => {
    ...
    /* Get BookingInternational by Id */
    async getBookingInternational(req, res) {
        await BookingInternationalModel.find({ 
            "_id": req.params.id
        })
            .then(result => {
    ...
    /* Update BookingInternational by ID */
    async updateBookingInternational(req, res) {
        await BookingInternationalModel.updateOne({
            "_id": req.params.id
        },{
            $set: req.body
        })
    ...
    /* Delete BookingInternational by ID */
    async deleteBookingInternational(req, res) {
        await BookingInternationalModel.deleteOne({ 
            "_id": req.params.id
        })
            .then(result => {
...
module.exports = BookingInternational